...
const UYUN_NetWork = (props) => {
    ...
    const localeMessage = defineMessages({
        ...
        network_step2Message: {
            id: 'alertApplication.network.step2Message',
            ...
            <div className={styles.viewContent}>
                ...
                </div>
                {
                    ...
                    <div className={styles.step2}>
                        ...
                        <p className={styles.stepName}>{formatMessage({...localeMessage['network_step2']})}</p>
                        <p className={styles.stepMessage}>{formatMessage({...localeMessage['network_step2Message']})}</p>
