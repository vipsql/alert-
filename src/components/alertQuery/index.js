...
import AlertOriginSliderWrap from './alertOriginSliderWrap'
...
class alertQueryManage extends Component {
  ...
  render() {
    ...
    const operateProps = {
      ...
      takeOverFunc: () => {
        dispatch({
          type: 'alertQueryDetail/takeOver'
        })
      },
      showReassiginFunc: () => {
        dispatch({
          type: 'alertQueryDetail/openReassign'
        })
      }
    }
    ...
    const reassignModalProps = {
      ...
      onOk: (selectedUser) => {
        dispatch({
          type: 'alertQueryDetail/submitReassign',
          payload: {
            toWho: selectedUser
          }
        })
      ...
      onCancel: () => {
        dispatch({
          type: 'alertQueryDetail/toggleReassignModal',
          payload: false
        })
      }
    }
