  ...
  for (var i = 0, len = numericAxisIds.length; i < len; i++) {
    ...
    for (var j = 0, sLen = stackIds.length; j < sLen; j++) {
      ...
      if (barItems && barItems.length) {
        var _barItems$0$props = barItems[0].props,
            dataKey = _barItems$0$props.dataKey,
            selfSize = _barItems$0$props.barSize;
...
var getBarPosition = exports.getBarPosition = function getBarPosition(_ref2) {
  ...
  if (sizeList[0].barSize === +sizeList[0].barSize) {
    ...
    (function () {
      ...
      var originalSize = (bandSize - 2 * offset - (len - 1) * barGap) / len >> 0;
...
var appendOffsetOfLegend = exports.appendOffsetOfLegend = function appendOffsetOfLegend(offset, items, props) {
  var children = props.children,
      width = props.width,
      height = props.height;

  var legendProps = getLegendProps(children, items, width);
